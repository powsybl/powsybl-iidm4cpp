...
iidm::Network BoundaryLineNetworkFactory::create() {
    iidm::Network network = createBase();
    iidm::BoundaryLine& boundaryLine = network.getVoltageLevel("VL").newBoundaryLine()
                .setId("BL")
                .setBus("BUS")
                .setR(10.0)
                .setX(1.0)
...
iidm::Network BoundaryLineNetworkFactory::createWithGeneration() {
    iidm::Network network = createBase();
    iidm::BoundaryLine& boundaryLine = network.getVoltageLevel("VL").newBoundaryLine()
                .setId("BL")
                .setBus("BUS")
...
iidm::Network BoundaryLineNetworkFactory::createBase() {
    iidm::Network network("boundary-line", "test");
...
void BoundaryLineNetworkFactory::createBoundaryLineCurrentLimits(iidm::BoundaryLine& boundaryLine) {
