...
GeneratorStartup::GeneratorStartup(Generator& generator, double predefinedActivePowerSetpoint, double marginalCost, double plannedOutageRate, double forcedOutageRate) :
    Extension(generator),
