...
void BusBreakerVoltageLevel::traverse(BusTerminal& terminal, VoltageLevel::TopologyTraverser& traverser) {
    std::vector<std::reference_wrapper<Terminal>> traversedTerminals;
    traverse(terminal, traverser, traversedTerminals);
}

void BusBreakerVoltageLevel::traverse(BusTerminal& terminal, VoltageLevel::TopologyTraverser& traverser, std::vector<std::reference_wrapper<Terminal>>& traversedTerminals) {
