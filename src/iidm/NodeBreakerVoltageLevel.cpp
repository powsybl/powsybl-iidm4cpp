...
void NodeBreakerVoltageLevel::traverse(NodeTerminal& terminal, VoltageLevel::TopologyTraverser& traverser) {
    std::vector<std::reference_wrapper<Terminal>> traversedTerminals;
    traverse(terminal, traverser, traversedTerminals);
}

void NodeBreakerVoltageLevel::traverse(NodeTerminal& terminal, VoltageLevel::TopologyTraverser& traverser, std::vector<std::reference_wrapper<Terminal>>& traversedTerminals) {
