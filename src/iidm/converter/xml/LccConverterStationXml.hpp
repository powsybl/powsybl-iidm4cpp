...
class LccConverterStationXml : public AbstractSimpleIdentifiableXml<LccConverterStation, LccConverterStationAdder, VoltageLevel>, public AbstractConnectableXml{
public:
...
protected:  // AbstractIdentifiableXml
    ...
    LccConverterStation& readRootElementAttributes(LccConverterStationAdder& adder, VoltageLevel& voltageLevel, NetworkXmlReaderContext& context) const override;
