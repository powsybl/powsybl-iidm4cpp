...
const IidmXmlVersions& IidmXmlVersion::all() {
    static std::vector<std::reference_wrapper<const IidmXmlVersion> > s_versions {{
        ...
        std::cref(IidmXmlVersion::V1_11()),
        std::cref(IidmXmlVersion::V1_12()),
        std::cref(IidmXmlVersion::V1_13()),
        std::cref(IidmXmlVersion::V1_14()),
        std::cref(IidmXmlVersion::V1_15()),
        std::cref(IidmXmlVersion::V1_16())
    }};
...
const IidmXmlVersion& IidmXmlVersion::V1_11() {
    static IidmXmlVersion V1_11("powsybl.org", {{1, 11}});
    return V1_11;
}

const IidmXmlVersion& IidmXmlVersion::V1_12() {
    static IidmXmlVersion V1_12("powsybl.org", {{1, 12}});
    return V1_12;
}

const IidmXmlVersion& IidmXmlVersion::V1_13() {
    static IidmXmlVersion V1_13("powsybl.org", {{1, 13}});
    return V1_13;
}

const IidmXmlVersion& IidmXmlVersion::V1_14() {
    static IidmXmlVersion V1_14("powsybl.org", {{1, 14}});
    return V1_14;
}

const IidmXmlVersion& IidmXmlVersion::V1_15() {
    static IidmXmlVersion V1_15("powsybl.org", {{1, 15}});
    return V1_15;
}

const IidmXmlVersion& IidmXmlVersion::V1_16() {
    static IidmXmlVersion V1_16("powsybl.org", {{1, 16}});
    return V1_16;
}
