...
protected:  // AbstractIdentifiableXml
    ...
    Switch& readRootElementAttributes(VoltageLevel::BusBreakerView::SwitchAdder& adder, VoltageLevel& voltageLevel, NetworkXmlReaderContext& context) const override;
