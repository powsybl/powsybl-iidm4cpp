...
#ifndef POWSYBL_IIDM_BOUNDARYLINEGENERATIONADDER_HPP
#define POWSYBL_IIDM_BOUNDARYLINEGENERATIONADDER_HPP
...
public:
    explicit GenerationAdder(BoundaryLineAdder& parent);
...
private:
    ...
    friend class iidm::BoundaryLineAdder;

private:
    BoundaryLineAdder& m_parent;
...
#endif  // POWSYBL_IIDM_BOUNDARYLINEGENERATIONADDER_HPP
