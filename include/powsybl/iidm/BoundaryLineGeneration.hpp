...
#ifndef POWSYBL_IIDM_BOUNDARYLINEGENERATION_HPP
#define POWSYBL_IIDM_BOUNDARYLINEGENERATION_HPP
...
private:
    Generation& attach(BoundaryLine& boundaryLine);

    friend BoundaryLine;

private:
    stdcxx::Reference<BoundaryLine> m_boundaryLine;
...
#endif  // POWSYBL_IIDM_BOUNDARYLINEGENERATION_HPP
