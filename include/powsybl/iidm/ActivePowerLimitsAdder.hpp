...
public:
    explicit ActivePowerLimitsAdder(OperationalLimitsGroup& owner);
    explicit ActivePowerLimitsAdder(OperationalLimitsGroup& owner, const ActivePowerLimits& limits);
