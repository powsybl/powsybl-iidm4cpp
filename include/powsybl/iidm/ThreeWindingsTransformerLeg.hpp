...
public:
    ...
    stdcxx::const_range<LoadingLimits> getAllSelectedLoadingLimits(const LimitType& type) const override;
    stdcxx::range<LoadingLimits> getAllSelectedLoadingLimits(const LimitType& type) override;
