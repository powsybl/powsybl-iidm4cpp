...
static const char* const B3 = "b3";
static const char* const BATTERY = "battery";
static const char* const BOUNDARY_LINE = "boundaryLine";
static const char* const BOUNDARY_LINE_ID1 = "boundaryLineId1";
static const char* const BOUNDARY_LINE_ID2 = "boundaryLineId2";
static const char* const BOUNDARY_REF = "boundaryRef";
static const char* const BRANCH_ID = "branchId";
static const char* const BRANCH_TRIPPING = "branchTripping";
...
static const char* const CONTROL_MODE = "controlMode";
...
static const char* const CURRENT_LIMIT = "currentLimit";
...
static const char* const DANGLING_LINE_ID1 = "danglingLineId1";
static const char* const DANGLING_LINE_ID2 = "danglingLineId2";
static const char* const DC_CONNECTED = "dcConnected";
static const char* const DC_GROUND = "dcGround";
static const char* const DC_I = "dcI";
static const char* const DC_LINE = "dcLine";
static const char* const DC_NODE = "dcNode";
static const char* const DC_P = "dcP";
static const char* const DC_SWITCH = "dcSwitch";
static const char* const DROOP_CURVE = "droopCurve";
...
static const char* const G3 = "g3";
static const char* const GENERATION = "generation";
static const char* const GENERATION_MAX_P = "generationMaxP";
static const char* const GENERATION_MIN_P = "generationMinP";
static const char* const GENERATION_TARGET_P = "generationTargetP";
static const char* const GENERATION_TARGET_Q = "generationTargetQ";
static const char* const GENERATION_TARGET_V = "generationTargetV";
...
static const char* const IDLE_LOSS = "idleLoss";
...
static const char* const K = "k";
static const char* const KEY = "key";
static const char* const KIND = "kind";
static const char* const LINE_COMMUTATED_CONVERTER = "lineCommutatedConverter";
static const char* const LCC_CONVERTER_STATION = "lccConverterStation";
static const char* const LIMITS_GROUP = "operationalLimitsGroup";
static const char* const LIMITS_GROUP_1 = "operationalLimitsGroup1";
static const char* const LIMITS_GROUP_2 = "operationalLimitsGroup2";
static const char* const LIMITS_GROUP_3 = "operationalLimitsGroup3";
...
static const char* const LOW_LIMIT = "lowLimit";
...
static const char* const MAX_V = "maxV";
...
static const char* const MIN_V = "minV";
static const char* const MINIMUM_VALIDATION_LEVEL = "minimumValidationLevel";
static const char* const MONITORED_ELEMENT_ID = "monitoredElementId";
...
static const char* const OPEN_ACTION = "openAction";
static const char* const OVERLOAD_MANAGEMENT_SYSTEM = "overloadManagementSystem";
static const char* const P = "p";
static const char* const P0 = "p0";
static const char* const PAIRING_KEY = "pairingKey";
static const char* const PCC_TERMINAL = "pccTerminal";
...
static const char* const PHASE_TAP_CHANGER2 = "phaseTapChanger2";
static const char* const PHASE_TAP_CHANGER3 = "phaseTapChanger3";
...
static const char* const RATED_S1 = "ratedS1";
static const char* const RATED_S2 = "ratedS2";
static const char* const RATED_S3 = "ratedS3";
static const char* const RATED_U0 = "ratedU0";
...
static const char* const RATIO_TAP_CHANGER1 = "ratioTapChanger1";
...
static const char* const REACTIVE_MODEL = "reactiveModel";
...
static const char* const RESISTIVE_LOSS = "resistiveLoss";
static const char* const RETAINED = "retained";
static const char* const RHO = "rho";
static const char* const SECTION = "section";
...
static const char* const SHUNT_NON_LINEAR_MODEL = "shuntNonLinearModel";
static const char* const SIDE = "side";
static const char* const SOLVED_SECTION_COUNT = "solvedSectionCount";
static const char* const SOLVED_TAP_POSITION = "solvedTapPosition";
...
static const char* const SWITCH_ID = "switchId";
static const char* const SWITCH_TRIPPING = "switchTripping";
static const char* const SWITCHING_LOSS = "switchingLoss";
...
static const char* const TARGET_VDC = "targetVdc";
...
static const char* const THREE_WINDINGS_TRANSFORMER_ID = "threeWindingsTransformerId";
static const char* const THREE_WINDINGS_TRANSFORMER_TRIPPING = "threeWindingsTransformerTripping";
...
static const char* const VOLTAGE_ANGLE_LIMIT = "voltageAngleLimit";
...
static const char* const VOLTAGE_LEVEL_REF = "voltageLevelRef";
...
static const char* const VOLTAGE_SOURCE_CONVERTER = "voltageSourceConverter";
