...
public:
     ...
     */
    static void runInBetweenVersions(const IidmXmlVersion& minVersion, const IidmXmlVersion& maxVersion, const IidmXmlVersion& contextVersion, const std::function<void()>& runnable);
