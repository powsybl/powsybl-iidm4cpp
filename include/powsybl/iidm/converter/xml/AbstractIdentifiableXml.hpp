...
protected:
    ...
    virtual std::string readIdentifierAttributes(Adder& adder, NetworkXmlReaderContext& context) const;
    virtual std::string skipIdentifierAttributes(NetworkXmlReaderContext& context) const;
...
private:
    virtual std::string getIdentifierAttributes(NetworkXmlReaderContext& context, std::string& id, std::string& name, bool& fictitious) const;
};
