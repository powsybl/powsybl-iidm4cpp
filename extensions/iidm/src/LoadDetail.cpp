...
LoadDetail::LoadDetail(Load& load, double fixedActivePower, double fixedReactivePower, double variableActivePower, double variableReactivePower) :
    Extension(load),
    m_fixedActivePower(checkPower(fixedActivePower, stdcxx::format("Invalid fixedActivePower"))),
    m_fixedReactivePower(checkPower(fixedReactivePower, stdcxx::format("Invalid fixedReactivePower"))),
    m_variableActivePower(checkPower(variableActivePower, stdcxx::format("Invalid variableActivePower"))),
    m_variableReactivePower(checkPower(variableReactivePower, stdcxx::format("Invalid variableReactivePower"))) {
}
