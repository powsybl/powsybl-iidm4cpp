...
#ifndef POWSYBL_IIDM_EXTENSIONS_IIDM_BATTERYSHORTCIRCUITXMLSERIALIZER_HPP
#define POWSYBL_IIDM_EXTENSIONS_IIDM_BATTERYSHORTCIRCUITXMLSERIALIZER_HPP
...
class BatteryShortCircuitXmlSerializer : public converter::xml::AbstractVersionableExtensionXmlSerializer {
...
public:
    ...
    ~BatteryShortCircuitXmlSerializer() noexcept override = default;
};
...
#endif  // POWSYBL_IIDM_EXTENSIONS_IIDM_BATTERYSHORTCIRCUITXMLSERIALIZER_HPP
