...
#ifndef POWSYBL_IIDM_EXTENSIONS_IIDM_GENERATORSTARTUP_HPP
#define POWSYBL_IIDM_EXTENSIONS_IIDM_GENERATORSTARTUP_HPP
...
public:
    GeneratorStartup(Generator& generator, double predefinedActivePowerSetpoint, double startupCost, double marginalCost, double plannedOutageRate, double forcedOutageRate);
...
#endif  // POWSYBL_IIDM_EXTENSIONS_IIDM_GENERATORSTARTUP_HPP
