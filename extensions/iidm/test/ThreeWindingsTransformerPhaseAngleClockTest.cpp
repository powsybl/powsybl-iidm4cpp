...
BOOST_AUTO_TEST_CASE(integrity) {
    ...
    POWSYBL_ASSERT_THROW(transformer.newExtension<ThreeWindingsTransformerPhaseAngleClockAdder>().withPhaseAngleClockLeg2(12UL).withPhaseAngleClockLeg3(0UL).add(), ValidationException, "3 windings transformer '3WT': Unexpected value for phaseAngleClock: 12");
    POWSYBL_ASSERT_THROW(transformer.newExtension<ThreeWindingsTransformerPhaseAngleClockAdder>().withPhaseAngleClockLeg2(0UL).withPhaseAngleClockLeg3(12UL).add(), ValidationException, "3 windings transformer '3WT': Unexpected value for phaseAngleClock: 12");
    ...
    POWSYBL_ASSERT_THROW(threewtpac.setPhaseAngleClockLeg2(12), ValidationException, "3 windings transformer '3WT': Unexpected value for phaseAngleClock: 12");
    ...
    POWSYBL_ASSERT_THROW(threewtpac.setPhaseAngleClockLeg3(12), ValidationException, "3 windings transformer '3WT': Unexpected value for phaseAngleClock: 12");
}
