...
**Note:** Under Windows or MacOS, the **Boost** libraries or **LibXML** libraries could be installed in a custom third parties folder, so you have to help `cmake` to find the required packages, using the `-DCMAKE_PREFIX_PATH` options:
```
