...
BOOST_FIXTURE_TEST_CASE(EntsoeAreaXmlSerializerTest, ResourceFixture) {
    Network network = createNetwork();
    ...
    const std::string& networkStr = ResourceFixture::getResource("/extensions/entsoe/entsoeArea.xml");
