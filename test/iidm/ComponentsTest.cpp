...
BOOST_AUTO_TEST_CASE(BusViewTest)
{
    ...
    POWSYBL_ASSERT_ENUM_EQ(logging::Level::DEBUG, logger.getLogMessage(1UL).getLevel());
    ...
    BOOST_CHECK_EQUAL(3UL, logger.size());
    POWSYBL_ASSERT_ENUM_EQ(logging::Level::DEBUG, logger.getLogMessage(2UL).getLevel());
