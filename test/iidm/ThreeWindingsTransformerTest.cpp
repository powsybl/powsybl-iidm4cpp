...
BOOST_AUTO_TEST_CASE(constructor) {
    ...
    const ThreeWindingsTransformer::Leg1& cLeg1 = cTransformer.getLeg1();
    BOOST_TEST(stdcxx::areSame(cLeg1, leg1));
    BOOST_CHECK_EQUAL("3WT_VL1_VL2_VL3 leg 1", leg1.toString());
    BOOST_CHECK_EQUAL("3WT_VL1_VL2_VL3 leg 1", cLeg1.toString());
    ...
    const ThreeWindingsTransformer::Leg2or3& cLeg2 = cTransformer.getLeg2();
    BOOST_TEST(stdcxx::areSame(cLeg2, leg2));
    BOOST_CHECK_EQUAL("3WT_VL1_VL2_VL3 leg 2", leg2.toString());
    BOOST_CHECK_EQUAL("3WT_VL1_VL2_VL3 leg 2", cLeg2.toString());
    ...
    const ThreeWindingsTransformer::Leg2or3& cLeg3 = cTransformer.getLeg3();
    BOOST_TEST(stdcxx::areSame(cLeg3, leg3));
    BOOST_CHECK_EQUAL("3WT_VL1_VL2_VL3 leg 3", leg3.toString());
    BOOST_CHECK_EQUAL("3WT_VL1_VL2_VL3 leg 3", cLeg3.toString());
...
BOOST_AUTO_TEST_CASE(integrity) {
    ...
    POWSYBL_ASSERT_THROW(leg1.setR(stdcxx::nan()), ValidationException, "3 windings transformer leg 1 '3WT_VL1_VL2_VL3': r is invalid");

    BOOST_TEST(stdcxx::areSame(leg1, leg1.setX(200.0)));
    BOOST_CHECK_CLOSE(200.0, leg1.getX(), std::numeric_limits<double>::epsilon());
    POWSYBL_ASSERT_THROW(leg1.setX(stdcxx::nan()), ValidationException, "3 windings transformer leg 1 '3WT_VL1_VL2_VL3': x is invalid");

    BOOST_TEST(stdcxx::areSame(leg1, leg1.setG(300.0)));
    BOOST_CHECK_CLOSE(300.0, leg1.getG(), std::numeric_limits<double>::epsilon());
    POWSYBL_ASSERT_THROW(leg1.setG(stdcxx::nan()), ValidationException, "3 windings transformer leg 1 '3WT_VL1_VL2_VL3': g is invalid");

    BOOST_TEST(stdcxx::areSame(leg1, leg1.setB(400.0)));
    BOOST_CHECK_CLOSE(400.0, leg1.getB(), std::numeric_limits<double>::epsilon());
    POWSYBL_ASSERT_THROW(leg1.setB(stdcxx::nan()), ValidationException, "3 windings transformer leg 1 '3WT_VL1_VL2_VL3': b is invalid");
    ...
    POWSYBL_ASSERT_THROW(leg1.setRatedU(stdcxx::nan()), ValidationException, "3 windings transformer leg 1 '3WT_VL1_VL2_VL3': rated U is invalid");
    ...
    POWSYBL_ASSERT_THROW(leg2.setR(stdcxx::nan()), ValidationException, "3 windings transformer leg 2 '3WT_VL1_VL2_VL3': r is invalid");

    BOOST_TEST(stdcxx::areSame(leg2, leg2.setX(700.0)));
    BOOST_CHECK_CLOSE(700.0, leg2.getX(), std::numeric_limits<double>::epsilon());
    POWSYBL_ASSERT_THROW(leg2.setX(stdcxx::nan()), ValidationException, "3 windings transformer leg 2 '3WT_VL1_VL2_VL3': x is invalid");
    ...
    POWSYBL_ASSERT_THROW(leg2.setRatedU(stdcxx::nan()), ValidationException, "3 windings transformer leg 2 '3WT_VL1_VL2_VL3': rated U is invalid");
    ...
    POWSYBL_ASSERT_THROW(leg3.setR(stdcxx::nan()), ValidationException, "3 windings transformer leg 3 '3WT_VL1_VL2_VL3': r is invalid");

    BOOST_TEST(stdcxx::areSame(leg3, leg3.setX(1000.0)));
    BOOST_CHECK_CLOSE(1000.0, leg3.getX(), std::numeric_limits<double>::epsilon());
    POWSYBL_ASSERT_THROW(leg3.setX(stdcxx::nan()), ValidationException, "3 windings transformer leg 3 '3WT_VL1_VL2_VL3': x is invalid");
    ...
    POWSYBL_ASSERT_THROW(leg3.setRatedU(stdcxx::nan()), ValidationException, "3 windings transformer leg 3 '3WT_VL1_VL2_VL3': rated U is invalid");
...
BOOST_AUTO_TEST_CASE(adder) {
    ...
    // Leg 1 tests
    ThreeWindingsTransformerAdder::Leg1Adder& l1Adder = adder.newLeg1();
    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 1: r is not set");
    l1Adder.setR(1.0);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 1: x is not set");
    l1Adder.setX(1.1);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 1: rated U is not set");
    l1Adder.setRatedU(1.2);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 1: g is not set");
    l1Adder.setG(1.3);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 1: b is not set");
    l1Adder.setB(1.4);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 1: voltage level is not set");
    l1Adder.setVoltageLevel("INVALID");

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 1: voltage level 'INVALID' not found");
    l1Adder.setVoltageLevel("VL1");

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 1: voltage level shall belong to the substation 'S2'");
    l1Adder.setVoltageLevel("VL4");

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 1: connectable bus is not set");
    l1Adder.setConnectableBus("VL4_BUS1");

    ThreeWindingsTransformerAdder adder2 = substation2.newThreeWindingsTransformer();
    adder2.newLeg1()
        .setR(1.0)
        .setX(1.1)
        .setRatedU(1.2)
        ...
        .setNode(1UL);
    POWSYBL_ASSERT_THROW(adder2.add(), ValidationException, "3 windings transformer leg 1: connection node and connection bus are exclusives");
    adder2.newLeg1()
        .setR(1.0)
        .setX(1.1)
        .setRatedU(1.2)
    ...
    // Leg 2 tests
    ThreeWindingsTransformerAdder::Leg2Adder& l2Adder = adder.newLeg2();
    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 2: r is not set");
    l2Adder.setR(2.0);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 2: x is not set");
    l2Adder.setX(2.1);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 2: rated U is not set");
    l2Adder.setRatedU(2.2);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 2: voltage level is not set");
    l2Adder.setVoltageLevel("INVALID");

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 2: voltage level 'INVALID' not found");
    l2Adder.setVoltageLevel("VL1");

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 2: voltage level shall belong to the substation 'S2'");
    l2Adder.setVoltageLevel("VL4");

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 2: connectable bus is not set");
    ...
    adder2.newLeg2()
        ...
        .setConnectableBus("VL4_BUS1")
        .setNode(1UL);
    POWSYBL_ASSERT_THROW(adder2.add(), ValidationException, "3 windings transformer leg 2: connection node and connection bus are exclusives");
    adder2.newLeg2()
        .setR(2.0)
        .setX(2.1)
        .setRatedU(2.2)
    ...
    // Leg 3 tests
    ThreeWindingsTransformerAdder::Leg3Adder& l3Adder = adder.newLeg3();
    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 3: r is not set");
    l3Adder.setR(3.0);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 3: x is not set");
    l3Adder.setX(3.1);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 3: rated U is not set");
    l3Adder.setRatedU(3.2);

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 3: voltage level is not set");
    l3Adder.setVoltageLevel("INVALID");

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 3: voltage level 'INVALID' not found");
    l3Adder.setVoltageLevel("VL1");

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 3: voltage level shall belong to the substation 'S2'");
    l3Adder.setVoltageLevel("VL4");

    POWSYBL_ASSERT_THROW(adder.add(), ValidationException, "3 windings transformer leg 3: connectable bus is not set");
    ...
    adder2.newLeg3()
        ...
        .setConnectableBus("VL4_BUS1")
        .setNode(1UL);
    POWSYBL_ASSERT_THROW(adder2.add(), ValidationException, "3 windings transformer leg 3: connection node and connection bus are exclusives");
    adder2.newLeg3()
        .setR(3.0)
        .setX(3.1)
        .setRatedU(3.2)
