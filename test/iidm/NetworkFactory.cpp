...
Network createTwoVoltageLevelNetwork() {
    Network network("test", "test");
    network.setCaseDate(stdcxx::DateTime::parse("2023-12-18T14:49:00.000+01:00"));
    ...
    // Disconnectors
    vl1.getNodeBreakerView().newDisconnector().setId("D_0_3").setOpen(false).setNode1(0).setNode2(4).add();
    vl1.getNodeBreakerView().newDisconnector().setId("D_1_3").setOpen(false).setNode1(1).setNode2(4).add();
    vl1.getNodeBreakerView().newDisconnector().setId("D_0_5").setOpen(false).setNode1(0).setNode2(5).add();
    vl1.getNodeBreakerView().newDisconnector().setId("D_1_5").setOpen(false).setNode1(1).setNode2(5).add();
    vl1.getNodeBreakerView().newBreaker().setId("BR_LOAD").setNode1(2).setNode2(4).setOpen(false).add();
    vl1.getNodeBreakerView().newBreaker().setId("BR_VL1").setNode1(3).setNode2(5).setOpen(true).add();
    vl2.getBusBreakerView().newSwitch().setId("BR_VL2").setBus1("BUS1").setBus2("BUS2").setOpen(false).add();
