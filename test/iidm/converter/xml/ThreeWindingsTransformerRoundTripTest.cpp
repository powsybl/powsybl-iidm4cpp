...
BOOST_FIXTURE_TEST_CASE(ThreeWindingsTransformerRoundTripTest, ResourceFixture) {
    const std::string& networkStr = ResourceFixture::getResource("/threeWindingsTransformerRoundTripRef.xml");
